...
<body>
	...
	<div class="container-fluid">
		<div class="row p-3">
			<%
			addBooksDAO dao2 = new addBooksDAO(Connect.getConnection());
			List<AddBookBean> list2 = dao2.getAllNewBook();
			for (AddBookBean b : list2) {
			%>
			<div class="col-md-3">
				<div class="card">
					<div class="card-body text-center ">
						...
						<div class="row">
							<a href="viewBook.jsp?bid=<%=b.getBid()%>"
								...
								class="btn btn-danger btn-sm ml-1">$ <%=b.getBprice()%></a>
						</div>
						<%
						} else {
